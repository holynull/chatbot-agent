...
def get_agent(
    ...
    doc_search_swft = RetrievalQA.from_chain_type(llm=llm_qa, chain_type=chain_type, retriever=vcs_swft.as_retriever(search_kwargs={"score_threshold": .7}),verbose=True)
    doc_search_path = RetrievalQA.from_chain_type(llm=llm_qa, chain_type=chain_type, retriever=vcs_path.as_retriever(search_kwargs={"score_threshold": .7}),verbose=True)
