...
def get_agent(
    ...
    agent = initialize_agent(tools=tools, llm=llm, agent=AgentType.CHAT_ZERO_SHOT_REACT_DESCRIPTION, verbose=True, memory=memory,callback_manager=agent_cb_manager)
    return agent
